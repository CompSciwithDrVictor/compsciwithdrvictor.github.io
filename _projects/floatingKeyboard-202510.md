...
![an image of the floating keyboard setup](/images/floatingKeyboard01.jpg)

Some time ago I decided to try out one of those "ergonomic keyboards" as I have been typing so much and wanted to make my typing experience better. One of the top results is something that "splits" a normal keyboard into 2 halves and angle them so that your hands will _naturally_ point towards a single point instead of forward and parallel. Having it split also allows the keyboard to physically be in two parts for more flexible placements.

After going through numerous options I found the [Keebio Iris CE](https://keeb.io/products/iris-ce-keyboard). Here are the reasons:
...
Turns out there aren't much options out there and one can't really buy anything for a bespoke keyboard like mine. Eventually I found a post on Reddit by someone who made a contraption that attaches the split keyboard to the arms of their chair [Reddit post](https://www.reddit.com/r/ErgoMechKeyboards/comments/1lvc5ri/split_keyboard_off_the_desk_my_ergonomic_mounting/). Unfortunately this person only listed a number of items they purchased from Aliexpress which I don't buy from. But then this led to me finding out something called "magic arm" from [another Reddit post](https://www.reddit.com/r/MechanicalKeyboards/comments/1ejzous/kinesis_advantage360_on_magic_arm/). Combining these I had an idea:
...
* magic arm [Amazon link](https://www.amazon.ca/dp/B0C4KGNHVT), which has a clamp on one side and allows the other side to be adjusted to any position and angle
* phone holder [Amazon link](https://www.amazon.ca/dp/B0DB1FGPZQ), which comes with a magnetic ring sticker that I can attach to my keyboard so that it can stay on the holder
...
![connecting the keyboard to the phone holder and to the magic arm](/images/floatingKeyboard02.jpg)

With a little trial and error and adjustment I got the angle and position just right. And the cat can lay on the desk.

![cozy cat](/images/floatingKeyboard03.jpg)
